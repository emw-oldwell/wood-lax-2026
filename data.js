...
const DATA = {
  ...
  events: [
    ...
    { date: "2026-06-20", name: "HHH Philly Classic (Day 1)", venue: "The Proving Grounds", venueAddress: "725 Conshohocken Rd, Conshohocken PA 19428", girls: "Both", lodgingKey: "WEST_CHESTER", driveFromLodging: "35 min", isHHH: true, note: "Home game — opponent TBD (per HHH calendar)" },
    { date: "2026-06-21", name: "HHH Philly Classic (Day 2)", venue: "The Proving Grounds", venueAddress: "725 Conshohocken Rd, Conshohocken PA 19428", girls: "Both", lodgingKey: "WEST_CHESTER", driveFromLodging: "35 min", isHHH: true, note: "Away game — opponent TBD (per HHH calendar)" },
    ...
    { date: "2026-07-08", name: "Nilly – Downingtown (Day 2)", venue: "United Sports Training Center", venueAddress: "1426 Marshallton Thorndale Rd, Downingtown PA 19335", girls: "Both", lodgingKey: "INDIGO", driveFromLodging: "16 min", isHHH: false, note: "Morning session — LWomen Summer Cup same day in Elkridge MD" },
    { date: "2026-07-08", name: "LWomen Summer Cup", venue: "Troy Park at Elkridge", venueAddress: "6500 Mansion Lane, Elkridge MD 21075", girls: "Both", lodgingKey: "INDIGO", driveFromLodging: "1h 30m", isHHH: true, note: "3–9 PM · Elite invite-only championship event · Drive to Spring Lake AFTER the game (~3h, late Chateau check-in)" },
